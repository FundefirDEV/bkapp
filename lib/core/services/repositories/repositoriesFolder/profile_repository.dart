...
class ProfileRepository {
  ...
  Future<Map<String, dynamic>> getProfile(String token) async {
    ...
    Future<Map<String, dynamic>> updateProfile(UpdatePeofile updatePeofile) async {
    final Map getProfile = await apiProvider.updateProfile(updatePeofile: updatePeofile);
    return getProfile;
  }
}
