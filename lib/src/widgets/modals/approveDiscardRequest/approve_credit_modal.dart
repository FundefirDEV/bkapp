...
//NOTE HOW TO CALL IT:
// showModalBottomSheet(context: context, builder: (BuildContext context) => ApproveCreditModal()),
class ApproveCreditModal extends StatelessWidget {
  @override
  ...
  Container _popDialog(BuildContext context) {
    return Container(
      key: Key('Main_container_approve_credit_modal'),
      color: Color(0xFF737373),
      child: Container(
        key: Key('Internal_container_approve_credit_modal'),
        ...
        decoration: BoxDecoration(
            ...
            color: Colors.white),
        child: Stack(
          key: Key('Stack_approve_credit_modal'),
          children: <Widget>[
  ...
  Align buildSaloAndText(context) {
    return Align(
        ...
        child: Column(
          key: Key('Column_approve_credit_modal'),
  ...
  Align closeButton(BuildContext context) => Align(
      ...
      child: FlatButton(
          key: Key('FlatButton_approve_credit_modal'),
  ...
  RichText buildRichText(context) {
    return RichText(
        key: Key('RichText_approve_credit_modal'),
        ...
        text: TextSpan(
            ...
            children: <TextSpan>[
              ...
              TextSpan(
                  text:  I18n.of(context).approvedRejectedModalAccepted,
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 20,
                    fontWeight: FontWeight.w700,
