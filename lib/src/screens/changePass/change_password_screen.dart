...
class ChangePassPage extends StatefulWidget {
  ...
  @override
  _ChangePassPageState createState() =>
      _ChangePassPageState(email: email, phone: phone);
}
...
class _ChangePassPageState extends State<ChangePassPage> {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: <Widget>[
          ...
          SingleChildScrollView(child: _change_pass_form(context)),
        ],
      ),
    );
  }
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            //height: SizeConfig.screenHeight * .73,
            ...
            child: Column(
              children: <Widget>[
                Text(
                  I18n.of(context).changePasswordFormTitle,
              ...
              return Padding(
                ...
                child: ElevatedButton(
                    child: Container(
                        ...
                        child: loadingSnapshot.data != null &&
                                loadingSnapshot.data
                            ? CircularProgressIndicator(
                                color: Colors.white,
                              )
                            : Text(
                                I18n.of(context).changePasswordChangePassSend)),
                    style: ButtonStyle(
                        // foregroundColor:
                    ...
                    onPressed: formValidSnapshot.hasData
                        ? () => summit(changePassBloc, context)
                        : null),
              );
            },
          );
  ...
  summit(ChangePassBloc changePassBloc, BuildContext context) {
    ...
    res.then(
        (value) => value ? _showConfirmDialog(context, changePassBloc) : null);
  }
