import 'package:bkapp_flutter/core/bloc/selectCityBloc/select_city_bloc.dart';
                ...
                children: <Widget>[
                  Theme(
                    ...
                    child: DropdownFieldBlocBuilder<String>(
                      key: Key('list-state'),
                      showEmptyItem: false,
                      selectFieldBloc: context.bloc<SelectCityBloc>().selectState,
                  ...
                  Align(
                   ...
                   Theme(
                     ...
                     child: DropdownFieldBlocBuilder<String>(
                       key: Key('list-city'),
                      showEmptyItem: false,
                      selectFieldBloc: context.bloc<SelectCityBloc>().selectCity,
                      decoration: InputDecoration(
                        border: InputBorder.none,
