...
void main() {
  group('Test Register Email Step', () {
    final RegisterEmailStepArgs data = RegisterEmailStepArgs('male', 'assets/images/man.svg');
    testWidgets('Find RegisterEmailStepScreen widget',
        (WidgetTester tester) async {
      final testKey = Key('my-id');
      await tester.pumpWidget(baseTester(
          child: RegisterEmailStepScreen(
              key: testKey,
              data: data)));
    ...
    testWidgets('Render GenderImage', (WidgetTester tester) async {
      await tester.pumpWidget(baseTester(child: RegisterEmailStepScreen(data: data)));
      await tester.pumpAndSettle();
    ...
    testWidgets('Find textField widget', (WidgetTester tester) async {
      await tester.pumpWidget(
        baseTester(child: RegisterEmailStepScreen(data: data))
      );
    ...
    testWidgets('Other push to RegisterPhoneStepScreen', (WidgetTester tester) async {
      await tester.pumpWidget(baseTester(child: RegisterEmailStepScreen(data: data)));
      await tester.pumpAndSettle();
