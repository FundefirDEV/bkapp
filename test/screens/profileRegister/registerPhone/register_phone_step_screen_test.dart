...
void main() {
  group('Test Register Phone Step', () {
    final RegisterPhoneStepArgs data = RegisterPhoneStepArgs('male', 'assets/images/man.svg');
    testWidgets('Find RegisterPhoneStepScreen widget',
        (WidgetTester tester) async {
      final testKey = Key('my-id');
      await tester.pumpWidget(baseTester(
          child: RegisterPhoneStepScreen(
              key: testKey,
              data: data)));
    ...
    testWidgets('Render GenderImage', (WidgetTester tester) async {
      await tester.pumpWidget(baseTester(child: RegisterPhoneStepScreen(data: data)));
      await tester.pumpAndSettle();
