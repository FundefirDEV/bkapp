...
void main() {
  ...
  group('Test invite modal', () {
    ...
    testWidgets('Test name hint error invite modal',
      ...
      await tester.testTextInput.receiveAction(TextInputAction.done);
      await tester.pumpAndSettle();
      await tester.enterText(find.byKey(Key('input_name_invite_modal')), '');
      await tester.testTextInput.receiveAction(TextInputAction.done);
      await tester.pumpAndSettle();
    ...
    testWidgets('Test phone hint error invite modal',
      ...
      await tester.enterText(find.byKey(Key('input_phone_invite_modal')), '32');
      await tester.testTextInput.receiveAction(TextInputAction.done);
      await tester.pumpAndSettle();
      expect(find.text('The number should be greater than 9'), findsOneWidget);

      await tester.enterText(find.byKey(Key('input_phone_invite_modal')), '');
      await tester.testTextInput.receiveAction(TextInputAction.done);
      await tester.pumpAndSettle();
      expect(find.text('This field is required'), findsOneWidget);
    });
